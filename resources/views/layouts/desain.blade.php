...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #4d148c">
        <div class="container">
            <a href="{{ url('/') }}"><img src="img/logoprodamas.png" alt="" width="40" height="40"
                    class="d-inline-block align-text-top" /></a>
            <a href="{{ url('/') }}" class="navbar-brand"
                style="padding-left: 5px; font-family: Inter, sans-serif">PRODAMAS</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto"
                    style="padding-right: 20px; font-weight: lighter; font-size: 13px; font-family: Inter, sans-serif">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ url('/') }}"><u>Beranda</u></a>
                    </li>
                    <li>
                        <div class="dropdown">
                            <a class="nav-link dropdown-toggle" href="{{ url('/tentang') }}" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                Tentang
                            </a>
                            <ul class="dropdown-menu menu-navigation" aria-labelledby="dropdownMenuLink">
                                ...
                                <li> <a class="dropdown-item menu" href="{{ url('/kampungkeren') }}"> Kampung Keren </a>
                                </li>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                        <li><button class="dropdown-item"><a href="{{ url('profil') }}"
                                    style="text-decoration: none; color: black;">Edit Profil</a></button></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><button class="dropdown-item"><a href="{{ url('logout') }}"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-1 col-lg-2 footer-logo" style="margin-top: 45px">
                        <a href=#><img class="logo-footer" src="img/logoprodamas.png" width="110" height="110"
                                alt="logo-footer" /></a>
                        <div style="margin-top: 12px">
                            <a href=#><img src="img/prodamas-text.png" alt="logo-prodamas-text" width="110" height="27"
                    ...
                    <div class="col-md-6 col-lg-5 footer-links" style="margin-top: 40px; color: white">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <a class="footer-link"
                                    href="https://survey123.arcgis.com/share/932769e15a27418aa9b448b0b1e6b6b6">Pengaduan
                                    Bank Sampah</a> <br>
                                <a class="footer-link"
