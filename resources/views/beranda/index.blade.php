...
<body>
    ...
    <div class="container">
      <div class="row mt-5">
        <div class="col text-center">
          <h2 style="font-family: Inter, sans-serif">Tentang</h2>
        </div>
      </div>
      <div class="row mt-3" style="font-family: Montserrat, sans-serif">
        <div class="col text-center">
          <h4>
            Program pembangunan dan pemberdayaan masyarakat, terobosan Pemerintah Kota Kediri yang ditujukan untuk mendorong partisipasi
            dan peran aktif masyarakat dalam pembangunan.
          </h4>
        </div>
      </div>
    </div>
  ...
  <div class="container artikel mb-5 mt-5">
    <h3 class="mb-3 text-center" style="font-family: Inter, sans-serif">Informasi Terupdate</h3>
  ...
  <section id="persentase">
    <div class="container mt-5">
      <div class="row text-center justify-content-center m-5">
        <h3 class="mb-5">Persentase Pembangunan Prodamas Plus 2021</h3>
      ...
      <div class="row justify-content-center">
        <div class="col-sm-6 col-md-3 hover-card mb-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Berada di sebelah timur Sungai Brantas Kecamatan Kota bisa dibilang merupakan jantung dari Kota Kediri.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6 col-md-3 hover-card mb-4">
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Kecamatan Mojoroto</h5>
              <p class="card-text">Terletak di sebelah barat aliran Sungai Brantas dan di lereng Gunung Klotok dan Maskumambang.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6 col-md-3 hover-card mb-4">
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Kecamatan Pesantren</h5>
              <p class="card-text">Pesantren adalah sebuah kecamatan di Kota Kediri, Provinsi Jawa Timur, Indonesia.</p>
            </div>
          </div>
        </div>
      </div>
